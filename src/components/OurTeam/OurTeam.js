          ...
          <div className="divhover">
            ...
            <div className="containerDescription">
              <h1 className="texto">
                ...
                tecnológicas del entorno y la voluntad de responder de la mejor manera posible a cada reto, hoy en día
                con un equipo bien entrenado bajo una sencilla pero muy efectiva organización. “En RTI Latina buscamos
                enfocarnos en el valor humano de la tecnología, las diversas formas en las que el desarrollo
                informático, cuando es impulsado como un sub-producto de la creatividad, tiene el potencial de mejorar
                la calidad de vida, ahorrando importantes cantidades de tiempo y esfuerzos que pueden reorientarse al
                enriquecimiento de una mejor y más amplia experiencia tanto dentro como más allá del trabajo diaro. La
                tecnología es una forma de arte.”
              </h1>
            </div>
          </div>
        </a>
